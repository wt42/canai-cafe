  ...
  return (
    <>
      <PageHeader
        ...
        title="Historical 2023 sales performance"
        description="This page explains what happened across the year using only valid transaction dates for time-based analysis."
      />

      <div className="grid three-columns">
        <InsightCard title="Best month" variant="highlight">
          {bestMonth.month} generated {formatCurrency(bestMonth.revenue)} in revenue.
        </InsightCard>
        <InsightCard title="Weakest month">
          {weakestMonth.month} generated {formatCurrency(weakestMonth.revenue)} in revenue.
        </InsightCard>
        <InsightCard title="Important limitation">
