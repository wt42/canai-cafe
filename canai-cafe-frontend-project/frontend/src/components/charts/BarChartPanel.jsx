...
export default function BarChartPanel({ title, subtitle, data, xKey = 'name', yKey = 'revenue' , yFormatter = chartCurrencyFormatter }) {
  return (
    <ChartFrame title={title} subtitle={subtitle}>
      <ResponsiveContainer width="100%" height={320}>
        <BarChart data={data} margin={{ top: 15, right: 20, left: 10, bottom: 70 }}>
          ...
          <Tooltip formatter={(value) => yFormatter(value)} />
